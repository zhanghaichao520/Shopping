...
List<Product> products = Product.getLatestProducts(5);
...
<div id="shop_hd_menu_all_category" class="shop_hd_menu_all_category">				<!-- 首页去掉 id="shop_hd_menu_all_category" 加上clsss shop_hd_menu_hover -->
		...
		<!-- Header Menu End -->
			...
			<div class="shop_hd_breadcrumb">
				<strong>当前位置：</strong> <span> <a href="">首页</a>&nbsp;›&nbsp;
							...
							%>
								<li>
									<dl>
										...
										<dd class="content">
											<span class="goods_jiage">￥<strong><%=p.getMemberPrice() %></strong></span> <span
												class="goods_chengjiao">最近成交5笔</span>
										</dd>
									</dl>
								</li>
							<%} %>
